...
public interface Handler {
	 ...
	 *            the new channel
	 * @param invokerid
	 *            client ID of who move the client (can be 0 if invokerName=Server)
	 * @param invokername
	 *            client name of who move the client
	 * @param invokeruid
	 *            client UID of who move the client (can be empty if
	 *            invokerName=Server)
	 * @param client
	 *            the client
	 * @see Handler#onClientMove(int, int, int)
	 ...
	 *            client ID of who kick the client (can be 0 if invokerName=Server)
	 * @param invokerName
	 *            client name of who kick the client
	 * @param invokerUID
	 *            client UID of who kick the client (can be empty if
	 *            invokerName=Server)
	 * @param reasonmsg
	 ...
	 *            the server connection ID
	 * @param targetmode
	 *            the target, {@link Handler#MESSAGE_TARGET_MODE_CHANNEL} or
	 *            {@link Handler#MESSAGE_TARGET_MODE_SERVER}
	 * @param msg
	 *            the sent message
	 * @param invokerid
	 *            CLID of who sent the message
	 * @param invokername
	 *            name of who sent the message
	 * @param invokeruid
	 *            UID of who sent the message
